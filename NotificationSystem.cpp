...
class SimpleNotification:public INotification{
   ...
   public:
    ...
    SimpleNotification(const string& str){
        this->text=str;
    }
...
class TimeStampDecorator:public INotificationDecorator{
     ...
     string getContent() const override{
        return "[2026-03-02  12:49:00]" + notification->getContent();
     }
};
...
// the notificationService manages notifications. It keeps track of notification.
...
class NotificationService{
    ...
    static NotificationService* getInstance(){
     ...
     // Expose the Obsevable so observer can attach
...
int main(){
    ...
    notificationEngine->addNotificationStrategy(new SMSStrategy("+91 9988998800"));
    ...
    // create Notification with Decurartor
